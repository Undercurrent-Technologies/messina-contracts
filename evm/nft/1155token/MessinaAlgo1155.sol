    ...
    IMessina1155
{
    struct State {
        ...
        // Mapping from address to its unique tokenID
    ...
    function getAddressTokenID(address account) external view returns (uint256) {
        return state.addressTokenID[account];
    }

    function getTokenIDCounter() external view returns (uint256) {
        return state.tokenIDcounter;
    }
    ...
    function bridgeMint(address to, uint256, uint256 amount, bytes memory data) public virtual override onlyNFTBridge {
    ...
    function bridgeMintBatch(address to, uint256[] memory, uint256[] memory amounts, bytes memory data) public virtual override onlyNFTBridge {
        uint256 tokenID = state.addressTokenID[to];
